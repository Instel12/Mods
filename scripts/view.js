...
const description = [
    "Extendable Menu is a menu that other mods add on to externally.<p>I will maybe make documentations on how to add your own mods later, however I don't use obfuscation so you may be able to decompile it and find out.<p>The default hotkey is [`] but it is configurable inside of the menu's config file.<p>This mod's only dependancy is BepInEx.<p><a href='/files/ExtendableMenu/1.1.0/Extendable.Menu.dll'>Download 1.1.0</a><p><a href='/files/ExtendableMenu/1.0.0/Extendable.Menu.dll'>Download 1.0.0</a>",
